// ESP8266 WiFi(ESP-01) <-> UART Bridge
// by RoboRemo
// www.roboremo.com
// by Kseryj for snap4arduino
...
#define UART_BAUD 57600 //config for Snap4Arduino
...
#ifdef MODE_AP
// For AP mode:
const char *ssid = "esp_wifi";  // You will connect your phone to this Access Point
const char *pw = "qwerty123"; // and this is the password
IPAddress ip(192, 168, 33, 1); //  connect to this IP
IPAddress netmask(255, 255, 255, 0);
const int port = 3030; // and this port
// You must connect the phone to this AP, then:
// menu -> connect -> Internet(TCP) -> 192.168.33.1:3030
#endif
